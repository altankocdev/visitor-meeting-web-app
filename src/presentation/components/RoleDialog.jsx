        ...
        <form onSubmit={handleSubmit(onSave)}>
          ...
          <div className={styles.groups}>{permissionGroups.map((group) => (
            <fieldset key={group.category}>
              ...
              {group.permissions.map((permission) => <label key={permission.id}><input type="checkbox" value={permission.id} {...register("permissionIds")} /><span><b>{permission.name}</b></span></label>)}
            </fieldset>
          ))}</div>
