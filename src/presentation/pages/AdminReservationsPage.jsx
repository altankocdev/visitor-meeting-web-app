...
function isFutureCancellable(reservation) {
  return Boolean(reservation)
    && ["ACTIVE", "PENDING_APPROVAL"].includes(reservation.status)
    && dayjs(reservation.startTime).isAfter(dayjs());
}
